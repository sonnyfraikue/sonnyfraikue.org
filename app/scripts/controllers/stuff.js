...
/**
 * @ngdoc function
 * @name sonnyfraikueorgApp.controller:AboutCtrl
 * @description
 * # AboutCtrl
 * Controller of the sonnyfraikueorgApp
 */
angular.module('sonnyfraikueorgApp')
  .controller('UsefulStuff', function ($scope, $http) {
